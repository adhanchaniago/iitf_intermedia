     ...
     <div class="roadmap-wrapper">
             ...
             <div class="hero-body has-text-centered">
                 <div class="columns">
                     <div class="column is-6 is-offset-3">
                         ...
                         <h1 class="title is-2  is-semibold is-spaced main-title">TIMELINE PERLOMBAAN</h1>
                         <h2 class="subtitle is-5  is-thin">
                             Timeline Perlombaan IITF secara lengkap
                         </h2>
                         <!-- CTA -->
                         <!-- <p>
                         </p> -->
             ...
             <ul>
                 <li>
                     <div>
                         ...
                         <time>02 September 2019</time>
                         <span class="item-content">
                             <b>Pembukaan Pendaftaran Perlombaan IITF</b> <br>
                             Pendaftaran dapat dilakukan secara online pada website IITF
                 ...
                 <li>
                     <div>
                         ...
                         <span class="item-content">
                             ...
                             Merupakan waktu terakhir bagi peserta untuk melakukan submisi atau pengumpulan file yang ingin diikutsertkan dalam perlombaan
                         </span>
                     </div>
                 </li>
                 <li>
                     <div>
                         ...
                         <time>30 September 2019 - 03 Oktober 2019</time>
                         <span class="item-content">
                             <b>Proses Seleksi</b><br>
                             Tim juri akan melakukan penilaian secara kolektif dari tiap-tiap kategori serta menentukan produk dari masing-masing kategori untuk menjadi nominasi yang berhak melaju ke Final.
                         </span>
                 ...
                 <li>
                     <div>
                         ...
                         <time>06 Oktober 2019</time>
                         <span class="item-content">
                             <b>Technical Meeting Finalis</b> <br>
                             Peserta lomba kategori tertentu datang ke Universitas Amikom Purwokerto untuk mengikuti Technical Meeting
                         </span>
                     </div>
                 </li>
                 <li>
                     <div>
                         ...
                         <time>12 & 13 Oktober 2019</time>
                         <span class="item-content">
                             <b>Pelaksanaan Perlombaan</b><br>
                             Finalis melaksanakan perlombaaan dan mempresentasikan produknya di hadapan juri
                         </span>
                     </div>
                 </li>
                 <li>
                     <div>
                         ...
                         <time>13 Oktober 2019</time>
                         <span class="item-content">
                             <b>Festival & Awarding</b><br>
                             merupakan puncak acara dari IITF dengan beragam acara didalamnya mulai dari Expo Product IT , Seminar , sampai penganugerahan untuk yang menjuarai lomba IT.
                         </span>
                     </div>
                 </li>
         ...
         <section>
             ...
             <div class="follow-us">
                 <a href="#roadmap" class="button k-button k-primary raised has-gradient is-fat is-bold" style="margin:auto">
