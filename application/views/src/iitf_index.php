        ...
        <div class="dark-wrapper">
            ...
            <section class="section is-medium is-end" id="reward">
                ...
                <div class="container">
                    ...
                    <!-- Title & subtitle -->
                    <h2 class="title is-light is-semibold has-text-centered is-spaced">HADIAH</h2>
                    <!-- Divider -->
                    <div class="divider is-centered"></div>
                    <h4 class="subtitle is-6 is-light has-text-centered is-compact">Hadiah unutk para juara dan masih banyak reward lainnya.</h4>
                                        ...
                                        <div class="column">
                                            <div class="container">
                                                <div class="hadiah-box animated preFadeInUp fadeInUp">
                                                    <div class="box-hadiah box-hadiah--1">
                                                        <img class="hadiah-trophy" src="assets/app/images/hadiah/gold.png" alt="juara 1">
                                                        <p class="juara">Juara 1</p>
                                                        <p class="nominal">Rp 000</p>
                                                        <p class="sertif">Sertifikat dan piala</p>
                                                    </div>
                                                    <div class="box-hadiah box-hadiah--2">
                                                        <img class="hadiah-trophy" src="assets/app/images/hadiah/silver.png" alt="juara 1">
                                                        <p class="juara">Juara 1</p>
                                                        <p class="nominal">Rp 000</p>
                                                        <p class="sertif">Sertifikat dan piala</p>
                                                    </div>
                                                    <div class="box-hadiah box-hadiah--3">
                                                        <img class="hadiah-trophy" src="assets/app/images/hadiah/bronze.png" alt="juara 1">
                                                        <p class="juara">Juara 1</p>
                                                        <p class="nominal">Rp 000</p>
                                                        <p class="sertif">Sertifikat dan piala</p>
                                                    </div>
